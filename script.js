...
locoScroll();
// Function to handle video playback on scroll
...
// Fade out section at the bottom
...
function canvas1() {
  const canvas = document.querySelector(".section18>canvas");
  const context = canvas.getContext("2d");
...
tl4.to(".section22>#snroff", {
  opacity: 0,
});

gsap.to(".section23>img", {
  scrollTrigger: {
    trigger: `.section23>img`,
    start: `top bottom`,
    end: `bottom 60%`,
    scrub: 0.5,
    scroller: `#main`,
